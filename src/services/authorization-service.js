...
import { CTF_CONTRACT, NEG_RISK_CTF_EXCHANGE, NEG_RISK_ADAPTER, USDC_CONTRACT, } from '../clients/ctf-client.js';
// Contract addresses
...
export class AuthorizationService {
    ...
    async approveAll() {
        ...
        const allApproved = erc20Results.every((r) => r.success) && erc1155Results.every((r) => r.success);
